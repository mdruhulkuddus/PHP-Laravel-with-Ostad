        ...
        <div class="card">
            <div class="row">
                <div class="col-md-5 wrapthumbnail">
                    <a href="post.html">
                        <div class="thumbnail" style="background-image:url({{ asset('frontendAssets/assets/img/demopic/1.jpg')}})">
                        </div>
                    </a>
                </div>
                <div class="col-md-7">
...
<section class="recent-posts">
    ...
    <div class="card-columns listrecent">
        ...
        <div class="card">
            <a href="post.html">
                <img class="img-fluid" src="{{ asset('frontendAssets/assets/img/demopic/5.jpg') }}" alt="">
            </a>
            <div class="card-block">
                <h2 class="card-title"><a href="post.html">{{ $event->title }}</a></h2>
                ...
                <div class="metafooter">
                    <div class="wrapfooter">
                        ...
                        <span class="author-meta">
						<span class="post-name"><a href="author.html">Ruhul</a></span><br/>
                            <i class="fa fa-calendar"></i>
						<span class="post-date">{{ $event->date }}</span><span class="dot"></span> <i class="fa fa-water"></i> <span class="post-read"> {{ $event->time }}</span>
						</span>
                        <span class="post-read-more"><a href="post.html" title="Read Story"><svg class="svgIcon-use" width="25" height="25" viewbox="0 0 25 25"><path d="M19 6c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v14.66h.012c.01.103.045.204.12.285a.5.5 0 0 0 .706.03L12.5 16.85l5.662 4.126a.508.508 0 0 0 .708-.03.5.5 0 0 0 .118-.285H19V6zm-6.838 9.97L7 19.636V6c0-.55.45-1 1-1h9c.55 0 1 .45 1 1v13.637l-5.162-3.668a.49.49 0 0 0-.676 0z" fill-rule="evenodd"></path></svg></a></span>
                    </div>
                </div>
