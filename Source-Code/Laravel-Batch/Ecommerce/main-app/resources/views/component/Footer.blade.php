<footer class="footer p-10 lg:px-44 mt-12  bg-base-200 text-base-content">
    <div>
...
<footer class="footer lg:px-44 py-4 border-t bg-base-200 text-base-content border-base-300">
